...
class TarjetaExplicacionWidget extends StatelessWidget {
  const TarjetaExplicacionWidget({super.key, required this.lineas, required this.advertencias});
          ...
          children: [
            Row(
              children: [
                ...
                Text('Asistente: explicacion del codigo',
            ...
            if (advertencias.isNotEmpty) ...[
              ...
              Row(
                children: [
                  Icon(Icons.warning_amber_rounded, color: AppTheme.ambarPwm, size: 18),
                  const SizedBox(width: 6),
                  Text('Advertencias', style: Theme.of(context).textTheme.titleSmall),
                ],
              ),
              const SizedBox(height: 6),
              ...advertencias.map((a) => Padding(
                    padding: const EdgeInsets.only(bottom: 4),
                    child: Text(a, style: TextStyle(color: AppTheme.ambarPwm.withValues(alpha: 0.9), fontSize: 12)),
                  )),
            ],
          ],
        ),
