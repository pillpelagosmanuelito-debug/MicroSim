...
/// (Modulo 1). Contenido de referencia: Arduino Uno (ATmega328P), la
...
const List<FichaArquitectura> catalogoArquitectura = [
  FichaArquitectura(
    ...
    datosClave: [
      ...
      'Ejecuta una instruccion por ciclo de reloj (arquitectura RISC)',
    ],
  ),
  FichaArquitectura(
    id: 'memoria',
    ...
    explicacion: 'Un microcontrolador tiene tres tipos de memoria con '
        ...
        'sobrevivir a un reinicio, pero se escribe mucho mas lento.',
    datosClave: [
      'Flash: 32 KB (programa) — se sube desde la computadora',
      'SRAM: 2 KB (variables en tiempo de ejecucion) — se borra al reiniciar',
  ...
  FichaArquitectura(
    ...
    datosClave: [
      ...
      '6 de ellos (3,5,6,9,10,11) admiten PWM (senal analogica simulada)',
  ...
  FichaArquitectura(
    ...
    datosClave: [
      ...
      'Alimentar directo a 5V+ el pin equivocado puede danar la placa',
    ],
  ),
];
