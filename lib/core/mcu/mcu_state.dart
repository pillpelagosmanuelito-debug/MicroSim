/// Un punto en el tiempo simulado, para graficar la evolución de un pin
/// digital (usado por el simulador de LED/motor del Módulo 3).
...
/// cuales 3/5/6/9/10/11 admiten PWM), 6 entradas analógicas (A0-A5),
...
class MCUState {
  ...
  /// Valores que el ESCENARIO inyecta (simulan un potenciómetro/LDR real
  ...
  void tomarMuestra() {
    ...
    // Límite razonable para no crecer sin fin en un loop muy largo.
